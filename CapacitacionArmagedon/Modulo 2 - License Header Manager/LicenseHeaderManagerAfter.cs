//-----------------------------------------------------------------------
// <copyright file="LicenseHeaderManagerAfter.cs" company="Chanchuyo.com">
...
namespace CapacitacionArmagedon.License_Header_Manager
{
    class LicenseHeaderManagerAfter
    {
        public LicenseHeaderManagerAfter(string[] args, int number)
        {
            Property1 = args[0];
            Property2 = args[1];
        ...
        public LicenseHeaderManagerAfter(string[] args)
        {
        }
