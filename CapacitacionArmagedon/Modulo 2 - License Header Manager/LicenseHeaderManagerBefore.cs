...
{
    //Ver CapacitacionArmagedon.licenseheader
    class LicenseHeaderManagerBefore
    {
        public LicenseHeaderManagerBefore(string[] args, int number)
        {
            Property1 = args[0];
            Property2 = args[1];
        ...
        public LicenseHeaderManagerBefore(string[] args)
        {
        }
